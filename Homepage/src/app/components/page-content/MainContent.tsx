...
import ShirtComponentTile5 from "../clothing/shirt/ShirtComponentTile5";
...
import JeansComponentTile5 from "../clothing/jeans/JeansComponentTile5";
...
const MainContent = () => {
	...
	return (
		<div className="space-y-8" style ={{height:"80rem"}}>
					...
					<div className="select is-fullwidth">
						<div className="flex flex-row">
							<div className="basis-1/12">
								<Tooltip
									title={[
										"1: Die Ressourcen, welche zur Herstellung des Kleidungsstücks genutzt wurden sind nicht oder wenig regenerativ.",
										<br />,
										"2: Die Ressourcen, die zur Herstellung des Kleidungsstücks genutzt wurden sind regenerativ.",
									]}
									placement="left"
								>
									<IconButton>
			...
			<div className="grid grid-cols-2 gap-8">
				...
				<div className="col-span-1 rounded-md bg-slate-200 py-24 p-8 text-center text-2xl font-semibold text-gray-900" style={{height: "20rem"}}>
					{shirtContentVisible && (
						<ShirtComponentTile1
							...
							valueCase={(valueRecyclingfähigkeit - 1) * 4 + valueLanglebigkeit + (1 - valueRegenerativität) * 4 * 3}
							data={
								data.filter(
			...
			<div className="grid grid-cols-3 gap-8">
				...
				<div className="rounded-md py-16 px-4 text-center text-xl font-semibold text-gray-900" style={{ backgroundColor: "#c0d103", height: "20rem"}}>
					{shirtContentVisible && (
						<ShirtComponentTile3
							valueRecyclingfähigkeit={valueRecyclingfähigkeit}
							valueLanglebigkeit={valueLanglebigkeit}
				...
				<div className="rounded-md bg-blue-200 py-16 px-4 text-center text-xl font-semibold text-gray-900" style={{ backgroundColor: "#41a4d2", height: "20rem"}}>
					{shirtContentVisible && (
						<ShirtComponentTile4
							valueRecyclingfähigkeit={valueRecyclingfähigkeit}
							valueLanglebigkeit={valueLanglebigkeit}
				...
				{/* Tile 5 für das ausgewählte Kleidungsstück*/}
				<div className="rounded-md bg-blue-300 py-16 px-4 text-center text-xl font-semibold text-gray-900" style={{ backgroundColor: "#259938", height: "20rem"}}>
					{shirtContentVisible && (
						<ShirtComponentTile5
							valueRecyclingfähigkeit={valueRecyclingfähigkeit}
							valueLanglebigkeit={valueLanglebigkeit}
